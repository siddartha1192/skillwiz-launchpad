...
const highlights = [
  { icon: Brain,     color: "#1EC8E8", title: "Live Platform Walkthrough",    body: "See the full platform in action — dashboards, analytics, and AI features demonstrated live for your context." },
  { icon: BarChart3, color: "#FF7A1A", title: "Custom ROI Analysis",          body: "We'll show you data from similar institutes and model the expected improvement in placement rate for yours." },
  { icon: Zap,       color: "#1EC8E8", title: "30-Day Free Trial",            body: "After the demo, get a fully configured trial environment for your institution at no cost." },
  { icon: Target,    color: "#FF7A1A", title: "Dedicated Onboarding Support", body: "A dedicated success manager will guide your team from setup to first results." },
];
...
export default function RequestDemo() {
  ...
  const inputCls = "w-full px-4 py-3.5 rounded-xl text-sm font-medium outline-none transition-all duration-200 border-2 bg-white focus:border-[#1EC8E8] focus:shadow-[0_0_0_4px_rgba(30,200,232,0.1)]";
      ...
      <div className="relative overflow-hidden pt-32 pb-20 px-4 text-center"
        ...
        <div className="relative z-10 max-w-2xl mx-auto">
          ...
          <h1 className="font-black text-white leading-tight mb-5"
            ...
            See SkillWiz in<br />
            <span style={{ color: "#1EC8E8" }}>Action — Live</span>
          </h1>
        ...
        <div className="grid lg:grid-cols-5 gap-12 items-start">
          ...
          <div className="lg:col-span-3">
            {submitted ? (
              <div className="rounded-3xl p-12 text-center"
                style={{ background: "white", boxShadow: "0 24px 80px rgba(13,27,62,0.1)", border: "2px solid rgba(30,200,232,0.2)" }}>
                <div className="w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6"
                  style={{ background: "rgba(30,200,232,0.1)" }}>
                  <CheckCircle2 size={40} style={{ color: "#1EC8E8" }} />
                </div>
              ...
              <form onSubmit={handleSubmit}
                ...
                <p className="text-sm mb-8" style={{ color: "rgba(13,27,62,0.45)" }}>Fill in the details and we'll get back to you within 24 hours.</p>
                    ...
                    {roles.map(r => {
                      ...
                      return (
                        <button type="button" key={r.id} onClick={() => setRole(r.id)}
                          ...
                          style={{
                            background: on ? "rgba(30,200,232,0.08)" : "rgba(13,27,62,0.03)",
                            border: `2px solid ${on ? "#1EC8E8" : "rgba(13,27,62,0.08)"}`,
                            color: on ? "#0d1b3e" : "rgba(13,27,62,0.45)",
                            transform: on ? "translateY(-2px)" : "none",
                          }}>
                          <Icon size={20} style={{ color: on ? "#1EC8E8" : "rgba(13,27,62,0.3)" }} />
                          {r.label}
                        </button>
                      );
                    })}
                ...
                <button type="submit"
                  ...
                  style={{ background: "linear-gradient(135deg,#FF7A1A,#FF9847)", boxShadow: "0 12px 36px rgba(255,122,26,0.4)" }}>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="rounded-3xl p-7"
              ...
              <p className="text-xs font-bold tracking-[3px] uppercase mb-5" style={{ color: "#FF7A1A" }}>What You'll Get</p>
                  ...
                  return (
                    <div key={i} className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <div className="text-xs leading-relaxed" style={{ color: "rgba(255,255,255,0.45)" }}>{h.body}</div>
                      </div>
                    </div>
                  );
                })}
            ...
            <div className="rounded-3xl p-6"
              ...
              <div className="grid grid-cols-3 gap-4 mb-5">
                {[
                  ...
                  { value: "94%",  label: "Placement",    color: "#5353C8" },
              ...
              <div className="space-y-3">
                {[
                  { icon: Phone, text: "+91-9850696969",       color: "#FF7A1A" },
                  { icon: Mail,  text: "info@myskillwiz.com",  color: "#1EC8E8" },
                  { icon: MapPin,text: "Pune, Maharashtra",    color: "#5353C8" },
